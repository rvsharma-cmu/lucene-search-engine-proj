...
my $fileIn = '/Users/raghavs/11642/QryEval/Experiments/HW3/OUTPUT_DIR/HW3.2-QryExpRefFBdocs10.teIn';
my $url = 'http://boston.lti.cs.cmu.edu/classes/11-642/HW/HTS/tes.cgi';

#  Fill in your USERNAME and PASSWORD below.

my $ua = LWP::UserAgent->new();
   $ua->credentials("https://boston.lti.cs.cmu.edu/classes/11-642/HW/HTS/tes.cgi", "HTS", "rvsharma@andrew.cmu.edu", "tXvSYGdl");
...
my $workbook = $parser->Parse('hw3.xlsx');
if ( !defined $workbook ) {
    die $parser->error(), ".\n";
}
...
$workbook->SaveAs('hw3.xls');

# create a new excel file
# my $workbook = Spreadsheet::WriteExcel->new('hw3.xls');
